...
prompt_conf = {
    ...
    "step_5_class_complete":
        ...
        3. 主方法要求：
           ...
           - 逻辑：跳过无相关信息的病例，仅将有效Observation加入Bundle，每个entry需含resource和request（method=POST，url=FHIR中提取的Parent参数）。
                ...
                for report in case_reports:
                    ...
                    fhir_bundle["entry"].append({{
                        ...
                        "request": {{
                            ...
                            "url": "Observation"  # Parent类型，与FHIR配置信息中的Parent字段对应
                        }}
                    }})
